...
### `US-311` · Entrenar el Modelo 1 - Regresion de matricula

| | |
|---|---|
| **Sprint** | S4 — Lun 24 - Dom 30 ago |
| **Objetivo** | Predecir variacion de matricula por escuela para el siguiente ciclo. MAE/RMSE con backtesting temporal. |
| **Entregable** | Código en su carpeta + documento en el vault con frontmatter + fila en la matriz |
| **Cómo se entrega** | Rama `feat/hector-marban-...` → PR con plantilla → revisión del Tech Lead → merge a `main` |

### `US-312` · Evaluar modelos y documentar metricas

| | |
|---|---|
| **Sprint** | S5 — Lun 31 ago - Dom 6 sep |
| **Objetivo** | Tabla comparativa, curvas y analisis de error por entidad. Va a `06_Quality_Testing/`. |
| **Entregable** | Código en su carpeta + documento en el vault con frontmatter + fila en la matriz |
| **Cómo se entrega** | Rama `feat/hector-marban-...` → PR con plantilla → revisión del Tech Lead → merge a `main` |

### `US-313` · Integrar predicciones y recomendaciones a Gold

| | |
|---|---|
| **Sprint** | S5 — Lun 31 ago - Dom 6 sep |
| **Objetivo** | Job batch que escribe `gold.predicciones` y `gold.recomendaciones` para DB-06 y DB-09. |
| **Entregable** | Código en su carpeta + documento en el vault con frontmatter + fila en la matriz |
| **Cómo se entrega** | Rama `feat/hector-marban-...` → PR con plantilla → revisión del Tech Lead → merge a `main` |
