...
| **Formato de entrega** | Rama `feat/luis-dominguez-...` → PR con plantilla completa → 2 aprobaciones → merge a `main` |
...
| **Cómo se entrega** | Rama `feat/luis-dominguez-...` → PR con plantilla → revisión del Tech Lead → merge a `main` |
