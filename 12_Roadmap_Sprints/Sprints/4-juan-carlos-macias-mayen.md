...
> **Rol:** Desarrollador backend · Inferencia ML y contratos de API · **Nivel asignado:** Medio
...
| **Formato de entrega** | Rama `feat/juan-mayen-...` → PR con plantilla completa → 2 aprobaciones → merge a `main` |
...
### `US-412` · Implementar los endpoints de inferencia ML
...
|---|---|
| **Sprint** | S4 — Lun 24 - Dom 30 ago |
| **Objetivo** | Esquemas Pydantic de entrada/salida por modelo, alineados al contrato de `gold.features_escuela`. Es la pieza que conecta Celula 3 y Celula 4. |
| **Entregable** | Código en su carpeta + documento en el vault con frontmatter + fila en la matriz |
| **Cómo se entrega** | Rama `feat/juan-mayen-...` → PR con plantilla → revisión del Tech Lead → merge a `main` |

### `US-416` · Implementar cache y manejo de errores de inferencia
...
pip freeze > requirements/celula-4.txt
```
...
|---|---|---|---|---|---|
| `US-412` | Implementar los endpoints de inferencia ML | ⬜ Por iniciar | 0% | — | Dom 30 ago |
| `US-415` | Implementar el contrato de datos entre API | ⬜ Por iniciar | 0% | — | Dom 30 ago |
