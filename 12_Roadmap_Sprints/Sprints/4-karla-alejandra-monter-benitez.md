---
id: SPRINT-KARLA-ALEJANDRA-MONTER-B
title: "Plan de Sprints — Karla Alejandra Monter Benitez"
...
| **Formato de entrega** | Rama `feat/karla-benitez-...` → PR con plantilla completa → 2 aprobaciones → merge a `main` |
...
| **Cómo se entrega** | Rama `feat/karla-benitez-...` → PR con plantilla → revisión del Tech Lead → merge a `main` |
