...
traces_up: ["07_Security/Security_Model"]
traces_down: ["08_CICD_DevOps/Environments", "05_Engineering/Environment_Setup"]
...
> [[08_CICD_DevOps/Environments]], [[07_Security/_index]], [[05_Engineering/Environment_Setup]]
> y [[11_Operations/Runbooks]].
...
- Si accidentalmente expusiste un secreto en un prompt, **rótalo de inmediato** y regístralo como `SEC-###`
  en [[07_Security/Security_Audit_Log]].
...
3. Registra el incidente como `SEC-###` en [[07_Security/Security_Audit_Log]].
4. Limpia el historial con `git filter-repo` o BFG (solo el Tech Lead de Cloud).
5. Documenta la causa raíz en [[10_Risk_Governance/Incident_Log]].
