...
> Límites y reglas de los agentes IA en el flujo de desarrollo. → [[09_AI_Governance/_index]]
...
Cada persona tiene un `Agent_Contexts/{nombre}.md` con archivos 🟢 propios / 🟡 compartidos /
...
3. Registrar incidente en [[10_Risk_Governance/Incident_Log]].
