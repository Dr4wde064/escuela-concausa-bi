---
id: AGENTCTX-KARLA-MONTER
title: "Agent Context — Karla Alejandra Monter Benitez"
owner: "Karla Alejandra Monter Benitez"
status: approved
traces_up: ["12_Roadmap_Sprints/Sprints/4-karla-alejandra-monter-benitez"]
tags: [ai, agent-context, ownership, celula-4]
---

# Agent Context — Karla Alejandra Monter Benitez
...
> → [[09_AI_Governance/AI_Agent_Governance]] · Plan: [[12_Roadmap_Sprints/Sprints/4-karla-alejandra-monter-benitez]]
...
| | |
|---|---|
| **Nombre** | Karla Alejandra Monter Benitez |
| **Célula** | Celula 4 — Backend, API & Seguridad |
| **Nivel** | Medio |
| **Rol** | Desarrolladora backend · Endpoints y RBAC |
| **Tech Lead de la célula** | Christian Imanol Ruiz Hurtado |
| **Quién revisa su código** | Christian Imanol Ruiz Hurtado (Tech Lead, compuerta técnica) → Edgar Coronel (PM, compuerta de proceso) |
...
- **DevLog obligatorio por sesión con IA**, antes del push (`_DevLog/YYYY-MM-DD-karla-monter-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR (`feat/karla-benitez-...`).
