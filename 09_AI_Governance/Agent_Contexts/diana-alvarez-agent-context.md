...
status: approved
traces_up: ["12_Roadmap_Sprints/Sprints/1-diana-aracely-alvarez-varela"]
...
> → [[09_AI_Governance/AI_Agent_Governance]] · Plan: [[12_Roadmap_Sprints/Sprints/1-diana-aracely-alvarez-varela]]
...
| ID | Sprint | Objetivo |
|---|---|---|
| US-101 | S1 | Contrato de las 3 capas: Bronze (raw + metadatos), Silver (tipado, CCT homologado) y Gold (esquema estrella). Incluye el parametro `SCOPE_ENTIDADES` y la politica de cobertura parcial. Documentar en `03_Architecture/Data_Model.md`. |
...
- **DevLog obligatorio por sesión con IA**, antes del push (`_DevLog/YYYY-MM-DD-diana-alvarez-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR (`feat/diana-varela-...`).
