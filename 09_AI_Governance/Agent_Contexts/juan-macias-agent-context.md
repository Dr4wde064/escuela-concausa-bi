...
> → [[09_AI_Governance/AI_Agent_Governance]] · Plan: [[12_Roadmap_Sprints/Sprints/4-juan-carlos-macias-mayen]]
...
- **DevLog obligatorio por sesión con IA**, antes del push (`_DevLog/YYYY-MM-DD-juan-macias-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR (`feat/juan-mayen-...`).
