---
id: AGENTCTX-DENI-GARRIDO
title: "Agent Context — Deni Garrido Fragoso"
owner: "Deni Garrido Fragoso"
status: approved
traces_up: ["12_Roadmap_Sprints/Sprints/1-deni-garrido-fragoso"]
tags: [ai, agent-context, ownership, celula-1]
---

# Agent Context — Deni Garrido Fragoso
...
> → [[09_AI_Governance/AI_Agent_Governance]] · Plan: [[12_Roadmap_Sprints/Sprints/1-deni-garrido-fragoso]]
...
| | |
|---|---|
| **Nombre** | Deni Garrido Fragoso |
| **Célula** | Celula 1 — Data Engineering & Quality |
| **Nivel** | Medio |
| **Rol** | Ingeniera de datos · Transformaciones dbt |
...
| ID | Sprint | Objetivo |
|---|---|---|
| US-111 | S2 | Limpieza, tipado, deduplicacion y homologacion de catalogos (CCT y clave de municipio INEGI a 5 digitos). |
| US-112 | S3 | Materializar hechos y dimensiones. Incluye tests nativos de dbt: unique, not_null, relationships, accepted_values. |
| US-113 | S3 | Vistas materializadas optimizadas para los 10 dashboards. Cada cubo debe exponer la bandera de cobertura para que el slice muestre 'sin dato disponible'. |
| US-114 | S5 | Perfilar queries lentas de dashboards y API; indices en Postgres; documentar el antes/despues. |

---

## 6. Reglas de uso de IA que aplican

- **DevLog obligatorio por sesión con IA**, antes del push (`_DevLog/YYYY-MM-DD-deni-garrido-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR (`feat/deni-fragoso-...`).
