...
status: approved
traces_up: ["12_Roadmap_Sprints/Sprints/2-monserrat-xcaret-miranda-olivas"]
...
> → [[09_AI_Governance/AI_Agent_Governance]] · Plan: [[12_Roadmap_Sprints/Sprints/2-monserrat-xcaret-miranda-olivas]]
...
- **DevLog obligatorio por sesión con IA**, antes del push (`_DevLog/YYYY-MM-DD-monserrat-miranda-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR (`feat/monserrat-olivas-...`).
