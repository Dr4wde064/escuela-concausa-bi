...
> → [[09_AI_Governance/AI_Agent_Governance]] · Plan: [[12_Roadmap_Sprints/Sprints/3-estefany-lucero-hernandez-loredo]]
...
- **DevLog obligatorio por sesión con IA**, antes del push (`_DevLog/YYYY-MM-DD-estefany-hernandez-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR (`feat/estefany-loredo-...`).
