...
status: approved
traces_up: ["12_Roadmap_Sprints/Sprints/5-edward-ulysses-ruiz-bustillos"]
...
> → [[09_AI_Governance/AI_Agent_Governance]] · Plan: [[12_Roadmap_Sprints/Sprints/5-edward-ulysses-ruiz-bustillos]]
...
- **DevLog obligatorio por sesión con IA**, antes del push (`_DevLog/YYYY-MM-DD-edward-ruiz-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR (`feat/edward-bustillos-...`).
