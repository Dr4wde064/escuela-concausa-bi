---
id: AGENTCTX-CARLOS-MAYORGA
title: "Agent Context — Carlos Guillermo Mayorga Tapia"
owner: "Carlos Guillermo Mayorga Tapia"
status: approved
traces_up: ["12_Roadmap_Sprints/Sprints/3-carlos-guillermo-mayorga-tapia"]
tags: [ai, agent-context, ownership, celula-3]
---

# Agent Context — Carlos Guillermo Mayorga Tapia
...
> → [[09_AI_Governance/AI_Agent_Governance]] · Plan: [[12_Roadmap_Sprints/Sprints/3-carlos-guillermo-mayorga-tapia]]
...
| | |
|---|---|
| **Nombre** | Carlos Guillermo Mayorga Tapia |
...
| ID | Sprint | Objetivo |
|---|---|---|
| US-304b | S5 | Indexar el esquema de Gold en ChromaDB (embeddings con sentence-transformers) y construir la consulta de contexto que alimenta al agente disenado por Andres en US-304a. |
| US-323 | S5 | 20 preguntas de negocio con su respuesta esperada, para probar el agente de forma objetiva. |
| US-324 | S5 | Una ficha por modelo en `15_ML_Models/`: proposito, features de entrada, metrica obtenida, limitaciones conocidas y en que contextos NO debe usarse la prediccion. |

---

## 6. Reglas de uso de IA que aplican

- **DevLog obligatorio por sesión con IA**, antes del push (`_DevLog/YYYY-MM-DD-carlos-mayorga-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR (`feat/carlos-tapia-...`).
