...
2. **Reemplaza los placeholders** en todos los archivos:
   ...
   ```
3. **Define el equipo** en [[00_Start_Here/Developer_Onboarding]] y crea un
   `09_AI_Governance/Agent_Contexts/{nombre}.md` por persona (usa la plantilla).
4. **Escribe el PRD** en [[01_Product/PRD]] (usa [[_Templates/PRD_template]]).
5. **Deriva requisitos** en [[02_Requirements/Requirements_General]] y `Requirements_Detailed`,
   y siembra la [[02_Requirements/Traceability_Matrix]].
6. **Configura enforcement:**
   - Copia [[_Templates/PULL_REQUEST_TEMPLATE]] a `.github/PULL_REQUEST_TEMPLATE.md`
   - Implementa los gates de [[08_CICD_DevOps/CI_Quality_Gates]] en tu `ci.yml`
   - Activa branch protection según [[05_Engineering/Branch_Protection]]
7. **Configura CLAUDE.md / AGENTS.md** del repo apuntando a este vault y a los Agent Contexts.
8. **Corre el linter** [[_Meta/Link_Hygiene]] para validar que todo enlaza.
