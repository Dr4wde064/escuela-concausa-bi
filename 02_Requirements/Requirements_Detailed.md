...
traces_up: ["01_Product/PRD_General_Materia", "01_Product/PRD"]
...
> ([[01_Product/PRD_General_Materia]] = QUÉ nos piden). Cada REQ indica **cómo lo resuelve FARO**
> ([[01_Product/PRD]] = CÓMO). Cada criterio de aceptación `AC-###` es **verificable** (cumplido/no
> cumplido, sin discusión).
> → [[02_Requirements/_index]] · [[02_Requirements/Traceability_Matrix]]
